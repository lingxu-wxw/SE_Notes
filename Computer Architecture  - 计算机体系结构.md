...
* 晶体管结构：nMOS晶体管在栅极为低电平时OFF，高电平时ON；pMOS晶体管在栅极低电平时ON，高电平时OFF
  ...
  ![1553873703370](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1553873703370.png)

* 晶体管Gate宽度：Gate Length = 2λ，feature size

  ![1553872260560](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1553872260560.png)
...
* 一个典型的数据中心
  ...
  ![1553872982341](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1553872982341.png)
...
* 计算机架构的发展史
  ...
  ![1554005252580](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554005252580.png)

* 四种传统的架构：stack，accumulator（直接操作内存），register-memory（CISC），register-oriented（RISC）

  ![1554004987623](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554004987623.png)
...
* 采用RISC的处理器：MIPS
  ...
  * 指令类型：R类型，I类型，J类型
  ...
  ![1554006637756](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554006637756.png)

  ![1554009565424](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554009565424.png)

* 指令集是硬件软件直接的接口

  * 高级程序语言 high level language - 汇编程序 low level language 指令集 ISA - 数据通路 register level transfer - 逻辑门电路 - CMOS 晶体管

  ![1554006772160](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554006772160.png)

  ![1554007542882](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554007542882.png)
...
* User ISA 和 System ISA
  ...
  * User ISA：使应用程序正常工作
    ...
    * 指代那些对应用程序可见的指令集：data flow，ALU operations， control flow
    ...
    ![1554007424976](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554007424976.png)
  ...
  * System ISA：管理/共享资源
    ...
    * 指代那些助管软件可见的指令集，比如OS，用于管理硬件资源
    ...
    ![1554007514074](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554007514074.png)
...
* 哈佛架构 Harvard Architecture
  ...
  * 将指令和数据的存储和信号通路物理层面地分开
  ...
  ![1554008207952](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554008207952.png)

* 五级流水线：指令级并行

  * 阶段：Instruction fetch -> Instruction decode and Register file Read -> Execute or Address calculation -> Memory access -> Write back

  ![1554008258099](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554008258099.png)
...
* 阶段量化 Stage Quantization
  ...
  * 将一些子过程拆分：子过程的更细粒度
  ...
  ![1554009162952](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554009162952.png)
...
* Dependence and Hazards
  ...
  * 可能的数据冒险类型：RAW, WAR, WAW
    ...
    ![1554102383105](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554102383105.png)
  ...
  * pipeline interlock：检测数据冒险、暂停pipeline的硬件机制称为pipeline interlock
    ...
    ![1554107402981](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554107402981.png)
...
* 动态调度：记分牌算法 Scoreboarding
  ...
  * 不同类型的FUs![1554104613004](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554104613004.png)
  ...
  * Scoreboarding的四个阶段
    ...
    * Write result：检查WAR冒险，可能stall
    ...
    ![1554104945676](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554104945676.png)
  ...
  * Scoreboarding执行界面
    ...
    * 执行时间是指在RO处停留的时间，贴图是中途的执行截图
    ...
    ![1554105118965](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554105118965.png)

    ![1554106193184](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554106193184.png)
...
* 动态调度：Tomasulo‘s Algorithm
  ...
  * Tomasulo's Algorithm的要点
  ...
  ![1554106061159](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554106061159.png)
  ...
  * Tomasulo's Algorithm执行界面
    ...
    * 值在算出来存进register result status的同时更新保留站的内容
    ...
    ![1554106576255](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554106576255.png)

    ![1554106942583](C:\Users\wxw\AppData\Roaming\Typora\typora-user-images\1554106942583.png)
