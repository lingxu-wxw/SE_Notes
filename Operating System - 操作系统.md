...
- Issue 3 ：Power Efficiency 能源效率
  ...
  - 典型服务器各组件的耗电情况
    ...
    ![1554557487878](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkdv5x1wj30he08dab5.jpg)
...
- Issue 4 ：Mobility 移动性
  ...
  - Android操作系统的架构
    ...
    ![1554557978966](http://ww4.sinaimg.cn/large/006tNc79ly1g3zke7akabj30g50blmyi.jpg)
...
- Issue 7 ：Non-Volatile Storage 非易失性内存
  ...
  - 新式的存储
    ...
    ![1554607824587](http://ww3.sinaimg.cn/large/006tNc79ly1g3zke4exj6j30p70cnjtk.jpg)
...
- Issue 8 ：Virtualization 虚拟化
  ...
  - 虚拟化架构
    ...
    ![1554608063907](http://ww1.sinaimg.cn/large/006tNc79ly1g3zkazyz3vj30hq08j3zn.jpg)
  ...
  - 虚拟化的方法
    ...
    ![1554608224031](http://ww1.sinaimg.cn/large/006tNc79ly1g3zkdzafolj30nw0aumyu.jpg)
...
- Kernel 分类：Monolithic, Microkernel, Exokernel, Hybrid
  ...
  ![1554882284901](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkb9c7r6j30cl0cdjs7.jpg)

  - UNIX：UNIX OS包括System program和kernel部分

   ![1554882436070](http://ww4.sinaimg.cn/large/006tNc79ly1g3zkasxpytj30jh0budht.jpg)
...
- Microkernel 系统架构
  ...
  ![1554883036112](http://ww4.sinaimg.cn/large/006tNc79ly1g3zke3i4srj30cq0b8jsl.jpg)
...
![1555892328783](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkay3lidj30f50abmy1.jpg)
...
![1555892720464](http://ww3.sinaimg.cn/large/006tNc79ly1g3zke4upd2j30jd09q0u2.jpg)
...
![1555893043340](http://ww1.sinaimg.cn/large/006tNc79ly1g3zkb70znrj30l30byq47.jpg)
...
![1555893901227](http://ww4.sinaimg.cn/large/006tNc79ly1g3zkaz3614j30ef0dsq45.jpg)
...
![1554458469403](http://ww2.sinaimg.cn/large/006tNc79ly1g3zke154enj30dd0a50ts.jpg)

- 页表项结构 PTE

![1555921993835](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkdzwfxhj30mp053wfc.jpg)
...
![1555922102326](http://ww4.sinaimg.cn/large/006tNc79ly1g3zkawqnerj30ml0780u9.jpg)
...
- Threading Model
  ...
  ![1557209601573](http://ww1.sinaimg.cn/large/006tNc79ly1g3zkdl8w6ij30jd07w75l.jpg)
...
- IPC的两种模型：如上图，message passing 和 shared memory
  ...
  ![1557209792779](http://ww1.sinaimg.cn/large/006tNc79ly1g3zkb392f4j30ft0apmxo.jpg)

- xv6中实现IPC的数据结构：struct pipe

  ![1557209952876](http://ww4.sinaimg.cn/large/006tNc79ly1g3zkdyqnzxj30gw067wf8.jpg)
...
- client thread上的调用顺序
  ...
  ![1557212448931](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkagwcstj30jc09wmy5.jpg)
...
- Intel CPU上的Exception簇
  ...
  ![1557213531390](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkadjgk4j30iz08ataj.jpg)
...
- Exception Handler
  ...
  - 处理器在栈上push return address，push 的可能是当前指令(如 page fault 时)，或者下一条指令(如硬件中断时)
  ...
  ![1558168046512](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkac4gdvj30gv09mt9e.jpg)
...
- 会触发user到kernel的几种事件 
  ...
  ![1558168902842](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkab6jmgj30js09jaa8.jpg)
...
- Interrupt hardware
  ...
  ![1558170109870](http://ww2.sinaimg.cn/large/006tNc79ly1g3zka8vn52j30jo07bmxh.jpg)
...
- APIC，IO-APIC 和 LAPIC
  ...
  ![1558170439701](http://ww2.sinaimg.cn/large/006tNc79ly1g3zka608ncj30h10780sn.jpg)
...
- Interrupt Priority 中断优先级
  ...
  ![1558176908532](http://ww4.sinaimg.cn/large/006tNc79ly1g3zka44plkj30fs05wt9c.jpg)
...
- CPU 如何找到 GDT/IDT 存在哪里
  ...
  ![1558179202556](http://ww4.sinaimg.cn/large/006tNc79ly1g3zka2e15qj30hs036web.jpg)

- CPU 如何找到 TSS 存在哪里

  - 专用系统段寄存器TR将描述符的偏移量保存到GDT中

  ​	![1558179309176](http://ww4.sinaimg.cn/large/006tNc79ly1g3zk9xm3uij30j908egly.jpg)
...
- 中断处理的哲学/核心思想
  ...
  - 在interrupt handler中尽可能少地执行操作，把不重要的行动推迟到后面做，就形成了top和bottom上下两半
    ...
    ![1558179662316](http://ww4.sinaimg.cn/large/006tNc79ly1g3zk9wahm5j30k904eweg.jpg)
...
![1558247236987](http://ww2.sinaimg.cn/large/006tNc79ly1g3zk9tdju5j30ji0c1dgf.jpg)

- 为什么interrupt handler不能sleep：防止死锁出现

![1558247436538](http://ww2.sinaimg.cn/large/006tNc79ly1g3zk9swzvpj30cv042mx8.jpg)
...
- 部分system call 列表
  ...
  ![1558247787338](http://ww4.sinaimg.cn/large/006tNc79ly1g3zk9q8evtj30j706o0va.jpg)

- 跟踪system call的执行

  - Linux可以使用ptrace 和strace来跟踪syscall，每次执行syscall时都会打印输出，包括参数和返回代码

  ![1558248471000](http://ww3.sinaimg.cn/large/006tNc79ly1g3zk9p5h8uj30hc0brt9f.jpg)
...
- 处理user pointer带来的fault
  ...
  ![1558250163187](http://ww1.sinaimg.cn/large/006tNc79ly1g3zk9ne6i9j30i309omxk.jpg)
...
- Flexible System Call
  ...
  ![1558253754026](http://ww1.sinaimg.cn/large/006tNc79ly1g3zk9lejj7j30hm099gnp.jpg)
...
- 三种类型的Device Interface
  ...
  ![1558272791435](http://ww3.sinaimg.cn/large/006tNc79ly1g3zk9k1ls8j30lt0c842o.jpg)
...
- user 如何处理device带来的timing问题
  ...
  - 同步和异步IO
    ...
    ![1558273730595](http://ww1.sinaimg.cn/large/006tNc79ly1g3zk9h26nkj30jy08qwgx.jpg)
...
- xv6 FS disk layout
  ...
  ![1560002634798](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkbas0fij30kf05omxx.jpg)
...
- block group
  ...
  ![1560003578547](http://ww2.sinaimg.cn/large/006tNc79ly1g3zke2k439j30kx07adh9.jpg)
...
- 数据块寻址的文件大小上限
  ...
  ![1560003810728](http://ww1.sinaimg.cn/large/006tNc79ly1g3zkaxb6knj30if0anmys.jpg)
...
- Extent 概述
  ...
  ![1560004008079](http://ww4.sinaimg.cn/large/006tNc79ly1g3zke7o6vsj30jr07jjsw.jpg)
...
- - ext3的log中有什么
    ...
    - ![image-20190618110253145](http://ww3.sinaimg.cn/large/006tNc79ly1g454no04zbj30te07iq3v.jpg)

- - - Ext 3 提升性能的两种方式

      - **批处理**：每隔几秒提交一次，而不是在每次系统调用之后，因此每个事务都包含许多系统调用

        提升性能的原因

        - 将固定事务成本分摊到多个事务中，包括描述符和 data block
      ...
      - **允许并发事务和系统调用**
        ...
        - 可能同时有多个事务
          1. 有些已经完全提交到磁盘日志中
          2. 有些讲对 log 的写入作为 commit 的一部分
          3. 还比如有的刚刚接收新系统调用的 “open”
        - ext3每隔几秒提交一次当前事务 (或者用 `fsync()` )
...
- cluster 和 sector
  ...
  ![1560078775928](http://ww4.sinaimg.cn/large/006tNc79ly1g3zke2ypaqj30ct06fmy0.jpg)

- FAT的结构

  ![1560077093726](http://ww4.sinaimg.cn/large/006tNc79ly1g3zke3vsxmj30ks01vjry.jpg)
...
- 结构：FAT 1 and FAT 2
  ...
  - FAT是一种链式结构，这样一个个块块就是cluster
    ...
    ![1560077885407](http://ww1.sinaimg.cn/large/006tNc79ly1g3zke5d2r0j30hp04rwf6.jpg)
...
- 结构：FAT root folder
  ...
  - file naming：支持长文件名，main folder entry存8.3 short file name，secondary folder entry存long file name
    ...
    ![1560078444246](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkb9u8bqj30if0av0v9.jpg)
...
- NTFS Cluster
  ...
  - 不同的集群大小取决于卷大小
  - ![1560079372934](http://ww1.sinaimg.cn/large/006tNc79ly1g3zkdweeyij30ca04bwez.jpg)

- NTFS的结构

  ![1560079412908](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkb2x8m6j30hx02274o.jpg)
...
- Master Boot Record：MBR
  ...
  - ![1560081984823](http://ww1.sinaimg.cn/large/006tNc79ly1g3zkdyacosj30k20d6q5u.jpg)
...
- NV-RAM 中存在的一些问题
  ...
  ![1560125796756](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkaypj3hj30jz07v75o.jpg)
...
- 闪存盘和普通磁盘的区别
  ...
  ![1560125994143](http://ww2.sinaimg.cn/large/006tNc79ly1g3zke0m3zgj30ks06hmyf.jpg)
...
- flexFS的架构分析
  ...
  ![1560126923254](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkdxv4suj30a50bt0ts.jpg)
...
- 架构：flash manager
  ...
  ![1560127426694](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkdvib5yj30ep028wep.jpg)
...
- 架构：performance manager
  ...
  - ![1560128158554](http://ww4.sinaimg.cn/large/006tNc79ly1g3zkat12lej30ct0algm3.jpg)

  - migration 的过程通常是放在background执行的，为了防止一整块出现IO request的response time delay，做一个切片

    ![1560128370190](http://ww4.sinaimg.cn/large/006tNc79ly1g3zkb62ggmj30gz0c2tar.jpg)

  - dynamic allocation的算法

    - 有一个参数 α，![1560128480827](http://ww4.sinaimg.cn/large/006tNc79ly1g3zkdxegsmj30bj01mjrd.jpg)
...
- 另一个可以的架构：SLC/MLC hybrid storage
  ...
  ![1560128889479](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkateohsj30ex05t0tk.jpg)
...
- LFS 概述
  ...
  ![1560129246728](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkb3xpflj30le04i750.jpg)
...
- 架构：design architecture
  ...
  ![1560143214322](http://ww1.sinaimg.cn/large/006tNc79ly1g3zke1lioxj30ja0ac76f.jpg)
...
- remote file service
  ...
  ![1560148495444](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkb1egszj30j70adwgl.jpg)
...
- 一些可能需要有点概念的常数（单位是访问时间）
  ...
  ![1560151830992](http://ww4.sinaimg.cn/large/006tNc79ly1g3zkba9k5rj30hu05u0u0.jpg)

  ![1560151846751](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkb54g32j30cg06ggmn.jpg)

- 三种内存模型：共享cache，共享mem，私有mem

  ![1560151791370](http://ww1.sinaimg.cn/large/006tNc79ly1g3zkb7kic6j30jt0d9mzw.jpg)
...
- Directory-based cache coherence
  ...
  ![1560152046256](http://ww4.sinaimg.cn/large/006tNc79ly1g3zke20go0j30hp0a5myu.jpg)
...
- lockset的算法
  ...
  ![1558580468315](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkawcwezj30s807x0uv.jpg)

![1558580911188](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkatzoa6j30gd0do3ze.jpg)

![1560253273041](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkb4bw6mj30k30e5774.jpg)
...
- architecture & interface
  ...
  ![1560258208422](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkb0zamqj30dj09vt9z.jpg)
...
- Design  space 
  ...
  ![1560259711632](http://ww2.sinaimg.cn/large/006tNc79ly1g3zke0bxzej30h70aj75x.jpg)
...
- system VM，same ISA
  ...
  ![1560259931312](http://ww2.sinaimg.cn/large/006tNc79ly1g3zke6udguj309u04ndg7.jpg)

  ![1560259941178](http://ww2.sinaimg.cn/large/006tNc79ly1g3zkb6ka0uj309v05gt95.jpg)
...
- VMM的三种不同的架构：
  ...
  ![1560260161986](http://ww3.sinaimg.cn/large/006tNc79ly1g3zke8ug5mj30k408utad.jpg)
...
- Host Monitor Architecture
  ...
  ![1560260445249](http://ww3.sinaimg.cn/large/006tNc79ly1g3zkazi5zvj30h20blmz1.jpg)
...
- Host Monitor Scheduling
  ...
  ![1560260612718](http://ww4.sinaimg.cn/large/006tNc79ly1g3zkb4pj6jj30hb0bozm6.jpg)
...
- Hypervisor
  ...
  ![1560261182465](http://ww2.sinaimg.cn/large/006tNc79ly1g3zke68h4vj30ap0bzq43.jpg)
